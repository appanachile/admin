<x-app-layout>
    ...
    @endsection
            ...
            <main class="pr-10">
                @livewire('producto-inteligente',['producto'=>$producto->id])
                ...
                <div class="max-w-6xl">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center mt-1">
                                    <label class="inline-flex items-center mr-4">
                                        {!! Form::radio('personalizable', 'si', $producto->personalizable == 'si', ['class'=>'form-radio']) !!}
                                        <span class="ml-2">Sí</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        {!! Form::radio('personalizable', 'no', $producto->personalizable == 'no', ['class'=>'form-radio']) !!}
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 w-full gap-x-2 mx-6">
                        <div class="mx-auto w-full bg-white col-span-2 py-4 px-6">
                                ...
                                <form action="{{route('productos.upload',$producto)}}"
                                    method="POST"
                                    class="dropzone"
